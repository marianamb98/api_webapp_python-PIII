...
def plot1d():
    ...
    # Dibujamos una senoidal scatter
    trace1 = go.Scatter(
        x=x_data,
        y=np.sin(x_data)
    )
    ...
    # Transformamos los datos y la configuración
    # de la vista del gŕafico (layout) en datos
    # que puedan ser incluidos en el HTML
...
def plot2d():
    # En este ejemplo se dibujan dos gráficos juntos
